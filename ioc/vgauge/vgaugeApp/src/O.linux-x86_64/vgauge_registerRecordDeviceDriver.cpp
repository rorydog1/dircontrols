...
/* Generated from ../O.Common/vgauge.dbd */
...
int vgauge_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/controls/ioc/vgauge";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"vgauge_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    vgauge_registerRecordDeviceDriver(*iocshPpdbbase);
}
