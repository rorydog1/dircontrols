...
/* Generated from ../O.Common/dg535.dbd */
...
{
    const char *bldTop = "/home/rory/Desktop/controls/dg535";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"dg535_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    dg535_registerRecordDeviceDriver(*iocshPpdbbase);
}
