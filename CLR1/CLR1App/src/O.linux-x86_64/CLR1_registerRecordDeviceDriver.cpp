...
/* Generated from ../O.Common/CLR1.dbd */
...
epicsShareExtern void (*pvar_func_mv2AsynRegistrar)(void);
...
int CLR1_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/rory/Desktop/controls/CLR1";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"CLR1_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    CLR1_registerRecordDeviceDriver(*iocshPpdbbase);
}
