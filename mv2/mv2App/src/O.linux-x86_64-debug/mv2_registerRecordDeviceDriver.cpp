...
/* Generated from ../O.Common/mv2.dbd */
...
int mv2_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/rory/Desktop/controls/mv2";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"mv2_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    mv2_registerRecordDeviceDriver(*iocshPpdbbase);
}
